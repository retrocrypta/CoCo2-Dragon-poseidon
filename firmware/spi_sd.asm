...
l75: # 
	...
	.lipcrel	l79
		add	r7
						...
						//../DeMiSTify/firmware/spi_sd.c, line 284
						//call
						//pcreltotemp
	...
	.lipcrel	l78
		add	r7
						...
						//../DeMiSTify/firmware/spi_sd.c, line 290
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 1 type 104
						// matchobj comparing flags 1 with 2
...
l78: # 
	...
	stmpdec	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 298
		// Offsets 2, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 302
						//setreturn
						// (obj to r0) flags 1 type 3
						// matchobj comparing flags 1 with 1
						// matchobj comparing flags 1 with 1
...
_sd_write_sector:
	...
	mr	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 310
		// Offsets 0, 0
		// Have am? no, no
		// flags 240, 260
						// (a/p assign)
...
l84: # 
	...
	st	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 326
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 1
	...
	st	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 329
		// Offsets 0, 0
		// Have am? no, no
		// flags 240, 260
						// (a/p assign)
	...
	st	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 331
		// Offsets 100000, 0
		// Have am? no, no
		// flags 1, 42
						// (a/p assign)
...
l89: # 
						...
						//../DeMiSTify/firmware/spi_sd.c, line 333
		// Offsets 0, 0
		// Have am? no, no
		// flags 240, 260
						// (a/p assign)
	...
	st	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 334
						//FIXME convert
						// (convert - reducing type 503 to 3
						// (prepobj r0)
 						// reg r1 - no need to prep
	...
	mr	r1
						...
						//../DeMiSTify/firmware/spi_sd.c, line 335
						// Q1 disposable
						// (test)
						// (obj to tmp) flags 4a type 3
...
l90: # 
						...
						//../DeMiSTify/firmware/spi_sd.c, line 336
						// Q1 disposable
						// Z disposable
		// Offsets 0, 0
		// Have am? yes, yes
	...
	st	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 337
		// Offsets 2, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 338
						//setreturn
						// (obj to r0) flags 1 type 3
						// matchobj comparing flags 1 with 1
						// matchobj comparing flags 1 with 1
...
l111: # 
	...
	st	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 372
		// Offsets 255, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	st	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 373
						// (test)
						// (obj to tmp) flags 42 type a
						// matchobj comparing flags 42 with 1
						// matchobj comparing flags 42 with 1
	...
	.lipcrel	l113
		add	r7
						...
						//../DeMiSTify/firmware/spi_sd.c, line 374
		// Offsets 16, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
l113: # 
						...
						//../DeMiSTify/firmware/spi_sd.c, line 376
						//setreturn
						// (obj to r0) flags 1 type 3
						// const
	.liconst	1
...
_sd_read_sector:
	...
	mr	r3
						...
						//../DeMiSTify/firmware/spi_sd.c, line 385
		// Offsets 255, -44
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
	...
	.lipcrel	l116
		add	r7
						...
						//../DeMiSTify/firmware/spi_sd.c, line 397
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 4a
...
l116: # 
	...
	st	r0
						...
						//../DeMiSTify/firmware/spi_sd.c, line 400
						// Q1 disposable
						//setreturn
						// (obj to r0) flags 42 type 3
						// matchobj comparing flags 42 with 1
...
l132: # 
	...
	.lipcrel	l132
		add	r7
						...
						//../DeMiSTify/firmware/spi_sd.c, line 417
						//FIXME convert
	...
	shl	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 423
						//pcreltotemp
	.lipcrel	l135
	add	r7
l127: # 
						...
						//../DeMiSTify/firmware/spi_sd.c, line 424
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r1)
	...
	or	r1
						...
						//../DeMiSTify/firmware/spi_sd.c, line 425
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r2)
	...
	and	r5
						...
						//../DeMiSTify/firmware/spi_sd.c, line 426
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r2)
	...
	or	r2
						...
						//../DeMiSTify/firmware/spi_sd.c, line 428
						// (bitwise/arithmetic) 	//ops: 2, 0, 2
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 4a
...
l133: # 
						...
						//../DeMiSTify/firmware/spi_sd.c, line 435
						// (bitwise/arithmetic) 	//ops: 5, 0, 5
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// const
	...
	shl	r4
						...
						//../DeMiSTify/firmware/spi_sd.c, line 436
						// (bitwise/arithmetic) 	//ops: 6, 0, 6
						// WARNING - q1 and target collision - check code for correctness.
						// (obj to tmp) flags 1 type 3
						// matchobj comparing flags 1 with 1
