...
_user_io_digital_joystick_ext:
	...
	add	r7
						...
						//../DeMiSTify/firmware/user_io.c, line 58
	...
	st	r0
						...
						//../DeMiSTify/firmware/user_io.c, line 59
		// Offsets 32, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
_user_io_digital_joystick:
	...
	add	r2
						...
						//../DeMiSTify/firmware/user_io.c, line 66
						//pcreltotemp
	.lipcrel	l15
	add	r7
l14: # 
...
l15: # 
						...
						//../DeMiSTify/firmware/user_io.c, line 67
						// (a/p push)
						// a: pushed 0, regnames[sp] r6
						// (obj to tmp) flags 2 type 3
						// var, auto|reg
...
_user_io_analogue_joystick:
	...
	st	r0
						...
						//../DeMiSTify/firmware/user_io.c, line 73
						// (bitwise/arithmetic) 	//ops: 0, 0, 2
	...
	st	r0
						...
						//../DeMiSTify/firmware/user_io.c, line 74
		// Offsets 32, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
...
l23: # 
						...
						//../DeMiSTify/firmware/user_io.c, line 82
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
	...
	.lipcrel	l23
		add	r7
						...
						//../DeMiSTify/firmware/user_io.c, line 83
		// Offsets 32, -48
		// Have am? no, no
		// flags 1, 21
						// (a/p assign)
